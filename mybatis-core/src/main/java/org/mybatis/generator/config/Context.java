...
public class Context extends PropertyHolder {
    ...
    public CustomConfiguration getCustomConfiguration(String type, String name) {
        return this.customConfigurationMap.get(CustomKeyUtil.getPropKey(type, name));
    }

    public void setCustomConfigurationMap(String name, CustomConfiguration customConfiguration) {
