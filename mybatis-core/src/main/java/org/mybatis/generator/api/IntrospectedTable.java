...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_COUNT_BY_CONDITION,
        ATTR_LIST_BY_IDS,
        ATTR_DELETE_BY_CONDITION
    }
    ...
    protected void calculateXmlAttributes() {
        ...
        PluginConfiguration baseMethodPlugin = ContextUtils.checkExtendModelPlugin(context);
        setCountByExampleStatementId("countByExample"); //$NON-NLS-1$
        setDeleteByExampleStatementId("deleteByExample"); //$NON-NLS-1$
        setDeleteByPrimaryKeyStatementId(ofNullable(MapperXmlUtils.getEnableDeleteByPrimaryKey(baseMethodPlugin),MethodEnum.DELETE.getValue())); //$NON-NLS-1$
        setInsertStatementId("insert"); //$NON-NLS-1$
        //setInsertSelectiveStatementId("insertSelective"); //$NON-NLS-1$
        setInsertSelectiveStatementId(MethodEnum.SAVE.getValue()); //$NON-NLS-1$
        setSelectAllStatementId("selectAll"); //$NON-NLS-1$
        setSelectByExampleStatementId("selectByExample"); //$NON-NLS-1$
        setSelectByExampleWithBLOBsStatementId("selectByExampleWithBLOBs"); //$NON-NLS-1$
        //setSelectByPrimaryKeyStatementId("selectByPrimaryKey"); //$NON-NLS-1$
        setSelectByPrimaryKeyStatementId(MethodEnum.GET.getValue()); //$NON-NLS-1$
        setSelectBySelectiveStatementId(MethodUtils.getSelectPoMethodStr(tableConfiguration.getDomainObjectName())); //$NON-NLS-1$
        ...
        setUpdateByPrimaryKeySelectiveStatementId(MethodEnum.UPDATE.getValue()); //$NON-NLS-1$
        ...
        //自定义mapper
        setListByIdsStatementId(ofNullable(MapperXmlUtils.getListByIds(baseMethodPlugin),MethodEnum.LIST_BY_IDS.getValue()));
        setCountByConditionStatementId(ofNullable(MapperXmlUtils.getCountByCondition(baseMethodPlugin),MethodEnum.COUNT.getValue()));
        setListByConditionStatementId(ofNullable(MapperXmlUtils.getListByCondition(baseMethodPlugin),MethodEnum.LIST.getValue()));
        setDeleteByConditionStatementId(ofNullable(MapperXmlUtils.getDeleteByCondition(baseMethodPlugin),MethodEnum.DELETE_BY_CONDITION.getValue()));
    }
    ...
    public void setSelectBySelectiveStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_SELECT_BY_SELECTIVE_STATEMENT_ID, s);
    }
    ...
    public String getListByIdsStatementId() {
        return
                (String) this.internalAttributes.get(InternalAttribute.ATTR_LIST_BY_IDS);
    }

    public void setListByIdsStatementId(String s) {
        this.internalAttributes.put(InternalAttribute.ATTR_LIST_BY_IDS, s);
    }

    public String getCountByConditionStatementId() {
        return
                (String) this.internalAttributes.get(InternalAttribute.ATTR_COUNT_BY_CONDITION);
    }

    public void setCountByConditionStatementId(String s) {
        this.internalAttributes.put(InternalAttribute.ATTR_COUNT_BY_CONDITION, s);
    }

    public String getListByConditionStatementId() {
        return
                (String) this.internalAttributes.get(InternalAttribute.ATTR_LIST_BY_CONDITION);
    }

    public String getDeleteByConditionStatementId() {
        return
                (String) this.internalAttributes.get(InternalAttribute.ATTR_DELETE_BY_CONDITION);
    }

    public void setListByConditionStatementId(String s) {
        this.internalAttributes.put(InternalAttribute.ATTR_LIST_BY_CONDITION, s);
    }

    public void setDeleteByConditionStatementId(String s) {
        this.internalAttributes.put(InternalAttribute.ATTR_DELETE_BY_CONDITION, s);
    }
    ...
    private static String ofNullable(String s,String other){
